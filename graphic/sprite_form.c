...
/*   Updated: 2020/08/01 16:51:54 by tfarenga         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_sprite_form(t_mlx *mlx, t_sprite *spr, int i)
{
	...
	spr->dist_conf = mlx->sprite2[mlx->order_s[i]].dist;
	spr->x_pos = (-mlx->play->x + mlx->sprite2[mlx->order_s[i]].s_x);
	spr->y_pos = (-mlx->play->y + mlx->sprite2[mlx->order_s[i]].s_y);
...
void	ft_print_spr(t_mlx *mlx, t_sprite spr, int y, int spr_n)
{
	...
	spr.y_pxl = spr.y_pxl / spr.height * mlx->img[4]->height;
